...
def homepage():
    ...
    def open_url():
        webb.open('https://youtu.be/0wp9ce3wkC4')  # 暫時
    ...
    def open_source():
        webb.open('https://github.com/billy-chen13579/Final-Product--My-Software')  # 暫時
